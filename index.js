...
var state;
var startingBlock = ENV.STARTINGBLOCK || 53264585; //GENESIS BLOCK
const username = ENV.ACCOUNT || 'hashkings'; //account with all the SP
const key = dhive.PrivateKey.from(ENV.skey); //active key for account
const ago = ENV.ago || 53264585;
...
function daily() {
    ...
    let waterNumber = Object.keys(obj).reduce((sum,key)=> (sum+parseInt(obj[key]||0 )  * state.stats.prices.waterPlants[obj].water  ) ,0);
