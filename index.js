...
var state;
var startingBlock = ENV.STARTINGBLOCK || 53207256; //GENESIS BLOCK
const username = ENV.ACCOUNT || 'hashkings'; //account with all the SP
const key = dhive.PrivateKey.from(ENV.skey); //active key for account
const ago = ENV.ago || 53207256;
          ...
          if (res) {
            ...
            if (errors) {
              ...
              if(json.contractPayload.symbol === "HKWATER" && json.contractPayload.memo) {
                ...
                var water = jp.query(state.users[from], `$.state.users['${from}'].seeds[?(@.id==${seedID})].properties.WATER`);  
