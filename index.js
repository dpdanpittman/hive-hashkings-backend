...
var state;
var startingBlock = ENV.STARTINGBLOCK || 50528470; //GENESIS BLOCK
const username = ENV.ACCOUNT || 'hashkings'; //account with all the SP
const key = dhive.PrivateKey.from(ENV.skey); //active key for account
const ago = ENV.ago || 50528470;
    ...
    processor.onOperation('transfer', function(json, from) {
        ...
        if (json.to == username && json.amount.split(' ')[1] == 'HIVE') {
                                ...
                                contract.createOneSeed(hivejs, 5, json.from).then((res) => {                                    
                                       ...
                                       console.log(res.operations[0][1].json.contractPayload.instances[0].propertys)
